...
class RemoveTorrentTest(unittest.TestCase):
    def __init__(self, testname, ip, data):
        super(RemoveTorrentTest, self).__init__(testname)
        self.rt = RemoveTorrent(ip, data)
...
if __name__ == "__main__":
    ...
    suite.addTest(RemoveTorrentTest("testRemoveTorrent", ip, data))
